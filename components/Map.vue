...
export default {
  ...
  mounted() {
    const states = [...this.$refs.states.children]
    states.forEach((c) => {
      c.addEventListener('mouseover', this.handleStateHover)
      c.addEventListener('mouseleave', this.handleStateMouseLeave)
    })
