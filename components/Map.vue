<template>
  <div>
    <div
      ref="infoBox"
      class="opacity-0 absolute top-0 left-0 z-10 bg-opacity-80 bg-white border-gray-500 border rounded-md p-2 transition duration-100"
    ></div>
    <svg
      version="1.1"
      id="us-map"
...
export default {
  ...
  methods: {
    handleStateHover(event) {
      ...
      infoBox.innerHTML = `<b>${this.stateCodes[event.target.id]}</b>`
